    ...
    <div className="app-shell">
      ...
      <main>
        ...
        <section className="scope-band">
          <div><span className="scope-icon"><Map size={19} /></span><span className="scope-copy"><strong>35 integrated counties</strong><span>Automatic parcel details where supported</span></span></div>
